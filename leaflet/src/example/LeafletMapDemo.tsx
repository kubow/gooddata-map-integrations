...
/**
 * LeafletMapDemo - Demonstrates the Leaflet map with sample data
 *
 * This component provides sample location data to showcase the map visualization
 * without requiring a live GoodData connection. Replace this with LeafletDataLoader
 * to use real data from your GoodData workspace.
 */
const LeafletMapDemo: React.FC = () => {
  // Sample data representing typical GoodData location output
  // In production, this would come from LeafletDataLoader
  ...
  return (
    <div className="demo-section">
      <LeafletMap points={samplePoints} />
      <p className="demo-note">
        <strong>Demo Mode:</strong> Displaying sample data. Connect to your
        GoodData workspace to visualize real location-based metrics.
      </p>
    </div>
  );
};
