...
/**
 * OpenLayersMapDemo - Demonstrates the OpenLayers map with sample data
 *
 * This component provides sample location data to showcase the map visualization
 * without requiring a live GoodData connection. Replace this with OpenLayersDataLoader
 * to use real data from your GoodData workspace.
 */
const OpenLayersMapDemo: React.FC = () => {
  // Sample data representing typical GoodData location output
  // In production, this would come from OpenLayersDataLoader
  ...
  return <OpenLayersMap points={samplePoints} />;
};

export default OpenLayersMapDemo;
